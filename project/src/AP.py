...
st.title("Ollama Chatbot with File Uploads")


uploaded_files = st.file_uploader("Upload your files", accept_multiple_files=True, type=["txt", "pdf", "docx"])
if uploaded_files:
...
if user_input:
    ...
    st.write(f"Ollama Response: {ollama_response}")
